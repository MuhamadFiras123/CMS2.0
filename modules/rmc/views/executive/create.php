...
$urlCreate = Url::base() . $module . '/executive/create';
    ...
    <div class="card-body mt-0">
        <div class="row">
            ...
            <?= $form->field($model, 'RMCSummaryBackground')->textarea([
                ...
                'id' => 'Field',
                'required' => true,
                'style' => 'width: 80%;' // Adjust width (100% means full width of the container)
            ...
            <div class="row">
                <div class="col-md-4">
                    <?= $form->field($model, 'RMCSummarySpecificObjective1')->textInput([
                        'maxlength' => true,
                        'type' => 'text',
                        'id' => 'Field',
                        'required' => true,
                ...
                <div class="col-md-4">
                    <?= $form->field($model, 'RMCSummarySpecificObjective2')->textInput([
                        'maxlength' => true,
                        'type' => 'text',
                        'id' => 'Field',
                        'required' => true,
                ...
                <div class="col-md-4">
                    <?= $form->field($model, 'RMCSummarySpecificObjective3')->textInput([
                        'maxlength' => true,
                        'type' => 'text',
                        'id' => 'Field',
                        'required' => true,
            ...
            <p><br>Research Methodology (Please state Description of Methodology, Flow Chart of Research Activities (as
                ...
                necessary)</p>
            <p>Expected Results/Benefit (Please State)</p>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">
                    <?php if ($RMCSummaryId) { ?>Update<?php } else { ?>Submit<?php } ?>
                </button>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
